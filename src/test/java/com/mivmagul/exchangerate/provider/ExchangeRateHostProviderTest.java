...
public class ExchangeRateHostProviderTest {

  @Mock private RestTemplate restTemplate;

  @InjectMocks private ExchangeRateHostProvider provider;

  @BeforeEach
  public void setup() throws Exception {
    setField(provider, "endpoint", "https://api.exchangerate.host/live");
